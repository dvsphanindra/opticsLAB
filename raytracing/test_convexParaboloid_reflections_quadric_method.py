...
b=1.5
r=0.5
parabolicSurface1 = Convex_Paraboloid(a,b, center=x1, radius=r, name='P1', mediumBefore='Air', mediumAfter='BK7', color=Color((0.3, 0.3, 1), alpha=0.3), parentCanvas=canvas)
...
incidentRay1 = Ray(ray2Start, rayDirection=Z_AXIS_DIRECTION, name='R1', length=1.2, wavelength=0.35, color='green', dc=False, parentCanvas=canvas)
...
print("Intersection point, distance, shape= ", intersection_point, intersection_distance, np.shape(intersection_distance))
P=Point(intersection_point[0], intersection_point[1], intersection_point[2], parentCanvas=canvas)
P.show(color='r')

n1=parabolicSurface1.calculate_quadric_normal(intersection_point)
