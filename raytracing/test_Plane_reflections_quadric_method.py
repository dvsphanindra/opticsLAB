...
incidentRay1 = Ray(ray1Start, rayDirection=Z_AXIS_DIRECTION, name='R1', length=1.2, wavelength=0.35, color='green', dc=False, parentCanvas=canvas)
...
A = 0; B = 0; C = 0; D = n[0]/2
E = 0; F = 0; G = n[1]/2; H = 0
I = n[2]/2; J = -np.dot(n,x1.get_coordinates())
