...
from opticsLAB.raytracing.component.opticalPrimitives.ParabolicLens import Lens
...
b = 4.0
r = 1.0
parabolicSurface1 = Concave_Paraboloid(a, b, center=x1, radius=r, name='Mirror1', mediumBefore='Air', mediumAfter='BK7',
                                      color=Color((0.1, 0.5, 1), alpha=0.1), parentCanvas=canvas)
# parabolicSurface1.rotate_aboutY(90)
parabolicSurface1.showNormal()

rectangularSurface1 = RectangularSurface(Point(0, 0, 1.5), mediumBefore='Air', mediumAfter='BK7',
...
# convexparabolicSurface1.showNormal()
#
x3 = Point(1.0, 0, 1.5)
e = 3
f = 2.5
r = 0.2
#
# convexparabolicSurface2 = Concave_Paraboloid(e,f,center=x3, radius=r, name='Mirror3', mediumBefore='Air',mediumAfter='BK7',
#                                              color=Color((0.3, 0.3, 1), alpha=0.3),parentCanvas=canvas)
#
# convexparabolicSurface2.rotate_aboutY(90)
# convexparabolicSurface2.showNormal()

#convexparabolicSurface1 = RectangularSurface(Point(1.0, 0, 1.5), mediumBefore='Air', mediumAfter='BK7',
                           # color=Color((0.3, 0.3, 1), alpha=0.3), parentCanvas=canvas)
...
#
# lens1 = Solid_Lens(e,f,center=x3, thickness=0.05, radius=r, rotation_axis='Y', angle=90, name='Mirror4', mediumBefore='Air',mediumAfter='BK7',
#                                              color=Color((0.3, 0.3, 1), alpha=0.3),parentCanvas=canvas)
# #lens1.rotate_aboutY(90)

lens2 = Lens(e,f,center=x3, radius=r, thickness=0.05,mediumBefore='Air',mediumAfter='BK7',
                                              color=Color((0.3, 0.3, 1), alpha=0.3),parentCanvas=canvas)
lens2.rotate_aboutY(90)
...
r1 = parabolicSurface1.calculate_ReflectedRay(incidentRay1)
r2 = rectangularSurface1.calculate_ReflectedRay(r1)
r3 = lens2.calculate_RefractedRay(r2)
# r1 = (incidentRay1.calculate_ReflectedRay(parabolicSurface1).calculate_ReflectedRay(rectangularSurface1).calculate_RefractedRay(lens2.front))
# r2 =  r1.calculate_RefractedRay(lens2.back)#.calculate_RefractedRay(convexparabolicSurface1).calculate_RefractedRay(convexparabolicSurface2)
# rr1 = r1.calculate_ReflectedRay(rectangularSurface1)
# rrr1 = rr1.calculate_RefractedRay(convexparabolicSurface1)



# ray2Start = Point(0.2, -0.2, -0.5, parentCanvas=canvas)
#
# # ray1Start = np.array((1,0,0))
...
#
#
# ray3Start = Point(-0.2, -0.2, -0.5, parentCanvas=canvas)
#
# # ray1Start = np.array((1,0,0))
...
#
#
# ray4Start = Point(0.2, 0.2, -0.5, parentCanvas=canvas)
#
# # ray1Start = np.array((1,0,0))
...
# # ################################################################
# #
# ray11Start = Point(-0.4, 0.4, -0.5, parentCanvas=canvas)
#
# # ray1Start = np.array((1,0,0))
...
#
# ray12Start = Point(0.4, -0.4, -0.5, parentCanvas=canvas)
#
# # ray1Start = np.array((1,0,0))
...
#
# ray13Start = Point(-0.4, -0.4, -0.5, parentCanvas=canvas)
#
# # ray1Start = np.array((1,0,0))
...
#
#
# ray14Start = Point(0.4, 0.4, -0.5, parentCanvas=canvas)
#
# # ray1Start = np.array((1,0,0))
