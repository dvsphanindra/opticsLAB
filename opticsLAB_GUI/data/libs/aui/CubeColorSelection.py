...
class CubeColourDialog(wx.Dialog):
    ...
    def __init__(self, parent, colourData=None, agwStyle=CCD_SHOW_ALPHA):
        ...
        # self.vispyColor = wx.TextCtrl(self.mainPanel, -1, "", style=wx.TE_READONLY)
        self.htmlName = wx.TextCtrl(self.mainPanel, -1, "", style=wx.TE_READONLY)
        comboBoxColorChoices = [ _(u"Red"), _(u"Green"), _(u"Blue"), _(u"Pink"), _(u"Yellow"), _(u"White"), _(u"Cyan"), _(u"LightSteelBlue"), _(u"Orange"), _(u"Brown"), _(u"Maroon"), _(u"Black"), _(u"Aqua"), _(u"Magenta"), _(u"Khaki") ]
        self.htmlComboBox = wx.ComboBox( self.mainPanel, wx.ID_ANY, _(u"LightSteelBlue"), wx.DefaultPosition, wx.DefaultSize, comboBoxColorChoices, 0 )
    ...
    def SetProperties(self):
        ...
        # self.vispyColor.SetInitialSize((80, -1))
        self.htmlCode.SetInitialSize((80, -1))
        self.htmlComboBox.SetInitialSize((120, -1))
    ...
    def DoLayout(self):
        ...
        # htmlSizer_c = wx.BoxSizer(wx.VERTICAL)
        ...
        htmlLabel2 = wx.StaticText(self.mainPanel, -1, _("Named Colors"))
        htmlSizer_a.Add(htmlLabel1, 0, wx.TOP, 3)
        htmlSizer_b.Add(htmlLabel2, 0, wx.TOP, 3)
        # htmlSizer_c.Add(htmlLabel3, 0, wx.TOP, 3)
        htmlSizer_a.Add(self.htmlCode, 0, wx.TOP, 3)
        # htmlSizer_b.Add(self.vispyColor, 0, wx.TOP, 3)
        htmlSizer_b.Add(self.htmlComboBox, 0, wx.CENTER, 3)
    ...
    def SetCodes(self):
        ...
        if colour in HTMLCodes:
            colourName, access, vispyColor = HTMLCodes[colour]
            # self.vispyColor.SetValue(vispyColor)
            self.accessCode.SetValue(access)
            self.htmlName.SetValue(colourName)
            self.htmlComboBox.SetValue(colourName)
        else:
            # self.vispyColor.SetValue("")
