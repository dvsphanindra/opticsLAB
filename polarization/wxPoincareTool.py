...
from component_definitions import Generic_Waveplate, Quarter_Waveplate, Half_Waveplate, Linear_Polariser, Project, Source, Detector
...
class wxPoincareTool(wxPoincareTool_GUI.mainFrame):
	...
	def __init__(self, parent):
		...
		self.available_Components = {name[0]: eval("cd." + name[0]) for name in inspect.getmembers(cd, inspect.isclass) if
		           name[0][0] != '_'} # Get the dictionary of available public classes in a module (classes not starting with '_')
