...
class mainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Poincare Sphere Visual", pos = wx.DefaultPosition, size = wx.Size( 1159,901 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
